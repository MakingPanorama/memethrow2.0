...
function pudge_meat_hook_lua:OnSpellStart()
	...
	self.hook_damage = self:GetSpecialValueFor( "hook_damage" ) + self:GetCaster():FindTalentValue("special_bonus_memethrow_scorpion_4")
	self.hook_speed = self:GetSpecialValueFor( "hook_speed" ) + self:GetCaster():FindTalentValue("special_bonus_memethrow_scorpion_5")
	self.hook_width = self:GetSpecialValueFor( "hook_width" )
	self.hook_distance = self:GetSpecialValueFor( "hook_distance" ) + self:GetCaster():FindTalentValue("special_bonus_memethrow_scorpion_6")
	...
	self.nChainParticleFXIndex = ParticleManager:CreateParticle( "particles/pudge_meathook.vpcf", PATTACH_CUSTOMORIGIN, self:GetCaster() )
