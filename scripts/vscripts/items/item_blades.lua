function ChekRanged(keys)
	local caster = keys.caster
	--[[if  caster:IsRangedAttacker() then
		keys.ability:ApplyDataDrivenModifier(caster, caster, "modifier_psi_blades_range", {})
	else caster:RemoveModifierByName("modifier_psi_blades_range") 
	end ]]
	if not caster:IsRangedAttacker() then 
		caster:RemoveModifierByName("modifier_psi_blades_range") 
	end
