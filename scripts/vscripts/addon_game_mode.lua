...
LinkLuaModifier("modifier_resist", "ability/gemeral.lua", LUA_MODIFIER_MOTION_NONE)
...
function Precache( context )
	...
	--Cache the creature models
		...
		PrecacheResource( "model", "models/items/juggernaut/generic_wep_broadsword.vmdl", context)
		PrecacheResource( "model", "models/items/juggernaut/bladesrunner_back/bladesrunner_back.vmdl", context)
		PrecacheResource( "model", "models/items/juggernaut/arcana/juggernaut_arcana_mask.vmd", context)
		...
		PrecacheResource( "model", "models/items/phantom_assassin/creeping_shadow_head/creeping_shadow_head.vmd", context)
		PrecacheResource( "model", "models/items/phantom_assassin/creeping_shadow_shoulder/creeping_shadow_shoulder.vmdl", context)
		PrecacheResource( "model", "models/items/phantom_assassin/creeping_shadow_weapon/creeping_shadow_weapon.vmdl", context)
		...
		PrecacheResource( "model", "models/items/chaos_knight/chaos_knight_ti7_shield/chaos_knight_ti7_shield.vmdl", context)
		...
		PrecacheResource( "model", "materials/models/heroes/hero_vaider/weapon/weapon.vmdl", context)
		PrecacheResource( "model", "models/props_gameplay/soccer_ball.vmdl", context)
    ...
    --Cache new particles
		...
		PrecacheResource( "particle", "particles/void_spirit_astral_step.vpcf", context )
		PrecacheResource( "particle", "particles/void_spirit_astral_step_impact.vpcf", context )
		...
		PrecacheResource( "particle", "particles/ember_spirit_flameguard.vpcf", context )
		...
		PrecacheResource( "particle", "particles/units/heroes/hero_techies/techies_bomb_crater.vpcf", context )
		PrecacheResource( "particle", "particles/units/heroes/hero_techies/techies_bomb_crater.vpcf", context )
		PrecacheResource( "particle", "particles/mud_golem_hurl_boulder", context )
		PrecacheResource( "particle", "particles/generic_hero_status/status_invisibility_start.vpcf", context )
		PrecacheResource( "particle", "particles/huskar_burning_spear_debuff.vpcf", context )
		PrecacheResource( "particle", "particles/clinkz_burning_army.vpcf", context )
		PrecacheResource( "particle", "particles/scarecrow_die_smoke.vpcf", context )
		PrecacheResource( "particle", "particles/chaos_knight_phantasm.vpcf.vpcf", context )
		PrecacheResource( "particle", "particles/units/heroes/hero_batrider/batrider_firefly_path.vpcf", context )
		PrecacheResource( "particle", "particles/clinkz_windwalk.vpcf", context )
		PrecacheResource( "particle", "particles/bristleback_viscous_nasal_goo.vpcf", context )
		PrecacheResource( "particle", "particles/tinker_laser.vpcf", context )
		PrecacheResource( "particle", "particles/pugna_life_drain.vpcf", context )
		PrecacheResource( "particle", "particles/shadow_demon_demonic_purge.vpcf", context )
		PrecacheResource( "particle", "particles/invoker_sun_strike.vpcf", context )
	...
	--Cache sounds for traps
		...
		PrecacheResource( "soundfile", "soundevents/naruto.vsndevts", context )
		...
		PrecacheResource( "soundfile", "soundevents/chubaka.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/finish_him.vsndevts", context )
		PrecacheResource( "soundfile", "soundevents/scorpion.vsndevts", context )
		...
		PrecacheResource( "soundfile", "soundevents/leo_slash.vsndevts", context)
		PrecacheResource( "soundfile", "soundevents/general_jmishenko.vsndevts", context)
		PrecacheResource( "soundfile", "soundevents/van_darkhome.vsndevts", context)
		PrecacheResource( "soundfile", "soundevents/dart_vader.vsndevts", context)
		PrecacheResource( "soundfile", "soundevents/game_sounds_heroes/game_sounds_bane.vsndevts", context)
		PrecacheResource( "soundfile", "soundevents/game_sounds_heroes/game_sounds_invoker.vsndevts", context)
		PrecacheResource( "soundfile", "soundevents/invoker.vsndevts", context)
		PrecacheResource( "soundfile", "soundevents/soccer.vsndevts", context)
		PrecacheResource( "soundfile", "soundevents/game_sounds_heroes/game_sounds_pangoiler.vsndevts", context)
...
--	CustomNetTables:SetTableValue( "test", "value 2", { a = 1, b = 2 } );
	...
	self.m_TeamColors = {}
	self.m_TeamColors[DOTA_TEAM_GOODGUYS] = { 255, 50, 50 }	--		красные ФАШИСТЫ
	self.m_TeamColors[DOTA_TEAM_BADGUYS]  = { 89, 89, 89 }	--		чёрные НАЦИСТЫ
	self.m_TeamColors[DOTA_TEAM_CUSTOM_1] = { 255, 187, 0 }		--      оранжевые КОММУНИСТЫ
	self.m_TeamColors[DOTA_TEAM_CUSTOM_2] = { 255, 255, 255 }	--		белые РАССИСТЫ
	self.m_TeamColors[DOTA_TEAM_CUSTOM_3] = { 255, 0, 255 }		--		розовые СЕКСИСТЫ
	self.m_TeamColors[DOTA_TEAM_CUSTOM_4] = { 65, 105, 225 }	--		синие ФЕМИНИСТЫ
	self.m_TeamColors[DOTA_TEAM_CUSTOM_5] = { 0, 255, 0 }		--		зелёные БДСМ
	self.m_TeamColors[DOTA_TEAM_CUSTOM_6] = { 0, 191, 255 }		--		голубые СЛАВА УКРАИНЕ
	self.m_TeamColors[DOTA_TEAM_CUSTOM_7] = { 140, 42, 244 }	--		фиолетовые ЛГБТ
	self.m_TeamColors[DOTA_TEAM_CUSTOM_8] = { 128, 128, 0 }		--		горчичные ХОЧУ ПИТСЫ
